...
import 'package:finality/data/network/model/manic/leaderboard_response.dart';
...
class ManicPriceDataSource {
  ...
  /// 获取排行榜数据
  Future<LeaderboardResponse> getLeaderboard(String wallet) {
    return _service.getLeaderboard(wallet);
  }
}
