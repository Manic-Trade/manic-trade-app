...
class PositionEvent {
  ...
  bool get isClosed => result == 'Closed';
  ...
  String get payoutAmount {
    final payoutLamports = payout ?? 0;
    final payoutAmount = (payoutLamports / 1000000).formatWithDecimals(2);
    return payoutAmount;
  }
  ...
  factory PositionEvent.fromJson(Map<String, dynamic> json) => PositionEvent(
        ...
        theoreticalValue: (json['theoretical_value'] as num?)?.toDouble(),
      );
}
