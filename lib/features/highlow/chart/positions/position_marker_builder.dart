...
class PositionMarkerBuilder {
  ...
  MarkerGroup _buildPositionMarkerGroup(
    ...
    if (showStandardMarkers) {
      ...
      chartMarkers.addAll([
        ...
        ChartMarker(
          ...
          quote: entryPrice,
          direction: direction,
          text: position.amountDisplay.withUsdSymbol(),
    ...
    final bool isActive = _tickMarkerIconPainter.isActiveMarker(positionId);
  ...
  MarkerGroup _buildSettledMarkerGroup(
    ...
    final spotPrice = settledEvent.position.entryPrice;
