    ...
    return _buildSection(
      ...
      children: [
        ...
        _buildRow([
          ...
          _buildGuideCheckBox(
            guidePoint: OptionsGuidePoint.livePositionsBar,
            title: 'Live positions bar',
            value: config.showLivePositionsBar,
            onLabelTap: () {
              showSettingManualSheet(
                context,
                title: "Live positions bar",
                description:
                    "The live positions bar at the top of the chart shows your open positions in real time, including confirmation status, entry price, and time remaining.",
                image: Image.asset(Assets.optionsChartShowLivePositionsBarDark),
              );
            },
            onChanged: (v) =>
                _configStore.update((c) => c.copyWith(showLivePositionsBar: v)),
          ),
        ]),
      ],
    );
