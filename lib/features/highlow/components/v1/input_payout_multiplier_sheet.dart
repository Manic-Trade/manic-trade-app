...
class _InputPayoutMultiplierSheetState
  ...
  late final HighLowSettingsStore _settingsStore =
      injector<HighLowSettingsStore>();
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.showHelperMessage) _buildHelperMessage(context),
                  Dimens.vGap40,
  ...
  Widget _buildHelperMessage(BuildContext context) {
    return Padding(
      ...
      child: Text(
        """Payout Multiplier affects the entry price offset. A higher multiplier increases the gap between your entry price and the current price, raising the difficulty to win while also boosting potential returns.
Choose wisely based on your market outlook.""",
...
class _CustomThumbShape extends SliderComponentShape {
  ...
  void paint(
    ...
    // 用两个填充圆叠加模拟边框，比描边圆抗锯齿效果更好
    // 外圆（边框色）
    final borderPaint = Paint()
      ..isAntiAlias = true
      ..color = borderColor
      ..style = PaintingStyle.fill;
    canvas.drawCircle(center, _thumbRadius + 0.75, borderPaint);
    ...
    final thumbPaint = Paint()
      ...
      ..style = PaintingStyle.fill;
    canvas.drawCircle(center, _thumbRadius - 0.25, thumbPaint);
...
Future<double?> showPayoutMultiplierSheet(
  ...
  MultiplierMode mode =
      initialMode ?? injector<HighLowSettingsStore>().getMultiplierMode();
