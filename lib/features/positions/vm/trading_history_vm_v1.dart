...
final tradingHistoryVMV1Provider = ViewModelProvider<TradingHistoryVMV1>((space) {
  return TradingHistoryVMV1(injector());
});

/// 交易历史页面 ViewModel
/// 支持分页加载全部交易历史
class TradingHistoryVMV1 extends ViewModel {
  TradingHistoryVMV1(this._dataSource);
