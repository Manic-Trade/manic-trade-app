...
class WalletAuthManager {
  ...
  WalletAuthManager(
    this._storage,
    ManicAuthDataSource manicAuthDataSource,
    this._turnkeyManager,
  ) : _turnkeyAuthUseCase =
            TurnkeyAuthUseCase(manicAuthDataSource, _turnkeyManager);
  ...
  Future<AuthResult> loginByWalletAccounts(
    ...
    final turnkeySolanaAccount = walletAccounts.accounts
        .firstWhereOrNull(
    ...
    final v1walletAccount = _turnkeyManager.wallets
        ?.firstWhereOrNull(
