...
class PrimaryAsyncButton extends StatelessWidget {
  const PrimaryAsyncButton({
    ...
    this.enableLoadingOpacity = false,
  });
  ...
  final bool enableLoadingOpacity;
    ...
    return NotificationListener<AsyncButtonNotification>(
      ...
      child: AsyncButtonBuilder(
        ...
        builder: (context, child, callback, buttonState) {
          ...
          if (enableLoadingOpacity &&
              loadingOpacity != null &&
              buttonState is Loading) {
            return Opacity(opacity: loadingOpacity!, child: filledButton);
          }
